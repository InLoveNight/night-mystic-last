    ...
    <div>
        <NuxtLinkLocale :to="`/intimacy-packs/${game.id}`"
            ...
            <h3 class=" text-lg font-black line-clamp-2">
                <span class=" text-xs bg-red-500 text-white px-2 py-1 rounded-lg  align-middle" v-if="game.aldult">18 +</span> {{ game.name }}
            </h3>
            ...
            <p class=" text-xs">
                <span class=" font-bold mr-1">{{ $t('category.category') }}:</span>
                <UBadge size="md"
                        variant="subtle">
            ...
            <div v-if="game.tags"
                ...
                <span class=" font-bold">{{ $t('category.tag') }}:</span>
